...
void customerKioskMenu() {
    ...
    while (true) {
        ...
        printMenuOption(1, "สร้างออเดอร์พิมพ์งานใหม่");
        printMenuOption(2, "ดูสถานะออเดอร์ของฉัน");
        printMenuOption(3, "ยกเลิกออเดอร์ของฉัน (เฉพาะที่ยังไม่ชำระเงิน/รับของ)");
        printMenuOption(4, "ชำระเงินออนไลน์");
        printMenuOption(0, "ออกจากระบบ (กลับเมนูเลือกโหมด)", RED);
...
void orderMenu() {
    while (true) {
        ...
        printMenuOption(1, "แสดงออเดอร์ทั้งหมด");
        printMenuOption(2, "ค้นหาออเดอร์");
        printMenuOption(3, "สร้างออเดอร์ใหม่");
        printMenuOption(4, "ยกเลิกออเดอร์");
        printMenuOption(5, "ดูสถานะคิว/เครื่องพิมพ์ (พร้อมเวลาที่เหลือ)");
        printMenuOption(6, "ตรวจสอบคิวซ้ำด้วยตนเอง (ปกติจับคู่ให้อัตโนมัติอยู่แล้ว)");
        printMenuOption(7, "แจ้งพิมพ์งานเสร็จก่อนเวลา (บังคับ Completed ด้วยตนเอง)");
        printMenuOption(8, "ยืนยันส่งมอบสินค้า (รับที่ร้าน/จัดส่งแล้ว)");
        printMenuOption(9, "ชำระเงินออนไลน์ (แทนลูกค้า)");
        printMenuOption(10, "ดูสถานะแบบเรียลไทม์ (นับเวลาถอยหลังสด ๆ อัปเดตทุกวินาที)");
